...
class DgFilesTraductionQuery extends AbstractQuery
{
    ...
    {
        $this->_findRangeBy['IdFile'] = array('from' => $from, 'to' => $to);
        $this->_load();
        return $this;
    }
    ...
    {
        $this->_findRangeBy['DateModification'] = array('from' => $from, 'to' => $to);
        $this->_load();
        return $this;
    }
    ...
    {
        $this->_filterRangeBy['IdFile'] = array('from' => $from, 'to' => $to);
        $this->_load();
        return $this;
    }
    ...
    {
        $this->_filterRangeBy['DateModification'] = array('from' => $from, 'to' => $to);
        $this->_load();
        return $this;
    }
    ...
    public function _getMap()
    {
        ...
        return array_merge($parentMap, array('Id' => 'id', 'IdFile' => 'id_file', 'Langue' => 'langue', 'Title' => 'title', 'Path' => 'path', 'Size' => 'size', 'DateModification' => 'date_modification'));
    }
}
