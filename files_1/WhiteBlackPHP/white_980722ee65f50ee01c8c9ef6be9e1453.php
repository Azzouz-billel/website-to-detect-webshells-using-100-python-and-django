...
class DgTranslatorVersionQuery extends AbstractQuery
{
    ...
    {
        $this->_findRangeBy['Id'] = array('from' => $from, 'to' => $to);
        $this->_load();
        return $this;
    }
    ...
    {
        $this->_findRangeBy['IdContent'] = array('from' => $from, 'to' => $to);
        $this->_load();
        return $this;
    }
    ...
    {
        $this->_findRangeBy['IdUser'] = array('from' => $from, 'to' => $to);
        $this->_load();
        return $this;
    }
    ...
    {
        $this->_findRangeBy['IdGroupe'] = array('from' => $from, 'to' => $to);
        $this->_load();
        return $this;
    }
    ...
    {
        $this->_findRangeBy['IsTranslated'] = array('from' => $from, 'to' => $to);
        $this->_load();
        return $this;
    }
    ...
    {
        $this->_findRangeBy['DateCreation'] = array('from' => $from, 'to' => $to);
        $this->_load();
        return $this;
    }
    ...
    {
        $this->_filterRangeBy['Id'] = array('from' => $from, 'to' => $to);
        $this->_load();
        return $this;
    }
    ...
    {
        $this->_filterRangeBy['IdContent'] = array('from' => $from, 'to' => $to);
        $this->_load();
        return $this;
    }
    ...
    {
        $this->_filterRangeBy['IdUser'] = array('from' => $from, 'to' => $to);
        $this->_load();
        return $this;
    }
    ...
    {
        $this->_filterRangeBy['IdGroupe'] = array('from' => $from, 'to' => $to);
        $this->_load();
        return $this;
    }
    ...
    {
        $this->_filterRangeBy['IsTranslated'] = array('from' => $from, 'to' => $to);
        $this->_load();
        return $this;
    }
    ...
    {
        $this->_filterRangeBy['DateCreation'] = array('from' => $from, 'to' => $to);
        $this->_load();
        return $this;
    }
    ...
    public function _getMap()
    {
        ...
        return array_merge($parentMap, array('Id' => 'id', 'IdContent' => 'id_content', 'Pseudo' => 'pseudo', 'IdUser' => 'id_user', 'IdGroupe' => 'id_groupe', 'Langue' => 'langue', 'TranslatedSentence' => 'translated_sentence', 'IsTranslated' => 'is_translated', 'DateCreation' => 'date_creation'));
    }
}
