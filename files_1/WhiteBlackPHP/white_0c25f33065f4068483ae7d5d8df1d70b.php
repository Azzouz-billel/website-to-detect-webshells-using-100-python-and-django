...
abstract class AbstractLanguageDataProviderTest extends AbstractDataProviderTest
{
    ...
    protected abstract function getDataDirectory();
    ...
    public function testGetNamesDefaultLocale()
    {
        ...
        $this->assertSame($this->dataProvider->getNames('de_AT'), $this->dataProvider->getNames());
    }
    public function testGetNamesSupportsAliases($alias, $ofLocale)
    {
        $this->assertEquals($this->dataProvider->getNames($ofLocale), $this->dataProvider->getNames($alias));
    }
