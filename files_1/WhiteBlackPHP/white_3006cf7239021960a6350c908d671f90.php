...
class PermissionsController extends AppController
{
    ...
    public function index($id = null, $level = null)
    {
        ...
        if ($root && $this->RequestHandler->ext == 'json') {
            $options = array_intersect_key($this->getRequest()->getQuery(), ['perms' => null, 'urls' => null]);
    ...
    protected function _setPermissionRoots()
    {
        ...
        foreach ($roots as $id => $root) {
            Croogo::hookAdminTab('Admin/Permissions/index', __d('croogo', $root->title), 'Croogo/Core.blank', ['linkOptions' => ['data-alias' => $root->alias]]);
        }
