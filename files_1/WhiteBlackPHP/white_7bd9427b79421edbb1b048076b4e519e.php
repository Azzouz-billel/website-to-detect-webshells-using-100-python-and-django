...
class WebsiteEntity extends AbstractEntity
{
    ...
    {
        return array('type' => 'int', 'size' => 11, 'unique' => false, 'required' => false, 'primary_key' => true, 'auto_increment' => true);
    }
    public function getValidationStatut()
    {
        return array('type' => 'int', 'size' => 11, 'unique' => false, 'required' => false, 'primary_key' => false, 'auto_increment' => false);
    }
    ...
    {
        return array('type' => 'varchar', 'size' => 255, 'unique' => false, 'required' => false, 'primary_key' => false, 'auto_increment' => false);
    }
    ...
    {
        return array('type' => 'varchar', 'size' => 220, 'unique' => false, 'required' => false, 'primary_key' => false, 'auto_increment' => false);
    }
    public function getValidationSlogan()
    {
        return array('type' => 'varchar', 'size' => 180, 'unique' => false, 'required' => false, 'primary_key' => false, 'auto_increment' => false);
    }
    public function getValidationCopyright()
    {
        return array('type' => 'varchar', 'size' => 100, 'unique' => false, 'required' => false, 'primary_key' => false, 'auto_increment' => false);
    }
    public function getValidationYear()
    {
        return array('type' => 'varchar', 'size' => 10, 'unique' => false, 'required' => false, 'primary_key' => false, 'auto_increment' => false);
    }
    ...
    {
        return array('type' => 'varchar', 'size' => 80, 'unique' => false, 'required' => false, 'primary_key' => false, 'auto_increment' => false);
    }
    public function getValidationAddresses()
    {
        return array('type' => 'text', 'size' => 0, 'unique' => false, 'required' => false, 'primary_key' => false, 'auto_increment' => false);
    }
    ...
    {
        return array('type' => 'varchar', 'size' => 25, 'unique' => false, 'required' => false, 'primary_key' => false, 'auto_increment' => false);
    }
    public function getValidationTelFix()
    {
        return array('type' => 'varchar', 'size' => 30, 'unique' => false, 'required' => false, 'primary_key' => false, 'auto_increment' => false);
    }
    ...
    {
        return array('type' => 'varchar', 'size' => 120, 'unique' => false, 'required' => false, 'primary_key' => false, 'auto_increment' => false);
    }
    ...
    {
        return array('type' => 'varchar', 'size' => 250, 'unique' => false, 'required' => false, 'primary_key' => false, 'auto_increment' => false);
    }
    public function getValidationAnalytics()
    {
        return array('type' => 'varchar', 'size' => 50, 'unique' => false, 'required' => false, 'primary_key' => false, 'auto_increment' => false);
    }
    ...
    {
        return array('type' => 'int', 'size' => 1, 'unique' => false, 'required' => false, 'primary_key' => false, 'auto_increment' => false);
    }
    ...
    public function _getMap()
    {
        ...
        return array_merge($parentMap, array('Id' => 'id', 'Statut' => 'statut', 'StatutVersion' => 'statut_version', 'StatutIp' => 'statut_ip', 'VersionDoorgets' => 'version_doorgets', 'Title' => 'title', 'Slogan' => 'slogan', 'Copyright' => 'copyright', 'Year' => 'year', 'Description' => 'description', 'Keywords' => 'keywords', 'Email' => 'email', 'Addresses' => 'addresses', 'Pays' => 'pays', 'Ville' => 'ville', 'Adresse' => 'adresse', 'Codepostal' => 'codepostal', 'TelFix' => 'tel_fix', 'TelMobil' => 'tel_mobil', 'TelFax' => 'tel_fax', 'Facebook' => 'facebook', 'Twitter' => 'twitter', 'Pinterest' => 'pinterest', 'Myspace' => 'myspace', 'Linkedin' => 'linkedin', 'Youtube' => 'youtube', 'Google' => 'google', 'Analytics' => 'analytics', 'Langue' => 'langue', 'LangueFront' => 'langue_front', 'LangueGroupe' => 'langue_groupe', 'Horaire' => 'horaire', 'Mentions' => 'mentions', 'Cgu' => 'cgu', 'MNewsletter' => 'm_newsletter', 'MComment' => 'm_comment', 'MCommentFacebook' => 'm_comment_facebook', 'MCommentDisqus' => 'm_comment_disqus', 'MSharethis' => 'm_sharethis', 'MSitemap' => 'm_sitemap', 'MRss' => 'm_rss', 'IdFacebook' => 'id_facebook', 'IdDisqus' => 'id_disqus', 'Theme' => 'theme', 'ThemeBootstrap' => 'theme_bootstrap', 'ModuleHomepage' => 'module_homepage', 'OauthGoogleId' => 'oauth_google_id', 'OauthGoogleSecret' => 'oauth_google_secret', 'OauthGoogleActive' => 'oauth_google_active', 'OauthFacebookId' => 'oauth_facebook_id', 'OauthFacebookSecret' => 'oauth_facebook_secret', 'OauthFacebookActive' => 'oauth_facebook_active', 'SmtpMandrillSsl' => 'smtp_mandrill_ssl', 'SmtpMandrillActive' => 'smtp_mandrill_active', 'SmtpMandrillHost' => 'smtp_mandrill_host', 'SmtpMandrillPort' => 'smtp_mandrill_port', 'SmtpMandrillUsername' => 'smtp_mandrill_username', 'SmtpMandrillPassword' => 'smtp_mandrill_password', 'StripeActive' => 'stripe_active', 'StripeSecretKey' => 'stripe_secret_key', 'StripePublishableKey' => 'stripe_publishable_key', 'PaypalDemo' => 'paypal_demo', 'PaypalActive' => 'paypal_active', 'PaypalUser' => 'paypal_user', 'PaypalPassword' => 'paypal_password', 'PaypalSignature' => 'paypal_signature', 'PaypalReturnurl' => 'paypal_returnurl', 'PaypalCancelurl' => 'paypal_cancelurl', 'TransferActive' => 'transfer_active', 'TransferTinymce' => 'transfer_tinymce', 'CheckActive' => 'check_active', 'CheckTinymce' => 'check_tinymce', 'CashActive' => 'cash_active', 'CashTinymce' => 'cash_tinymce', 'Currency' => 'currency', 'SaasHost' => 'saas_host', 'SaasHostInt' => 'saas_host_int', 'SaasName' => 'saas_name', 'SaasUser' => 'saas_user', 'SaasPassword' => 'saas_password', 'SaasArchive' => 'saas_archive', 'SaasPosition' => 'saas_position', 'DateCreation' => 'date_creation', 'DateModification' => 'date_modification'));
    }
