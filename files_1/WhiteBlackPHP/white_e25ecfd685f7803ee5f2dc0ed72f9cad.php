...
class getid3_mp3 extends getid3_handler
{
    ...
    public function Analyze()
    {
        ...
        if (isset($info['mpeg']['audio']['LAME'])) {
            ...
            if (!empty($info['mpeg']['audio']['LAME']['long_version'])) {
                $info['audio']['encoder'] = rtrim($info['mpeg']['audio']['LAME']['long_version'], "\0");
            } elseif (!empty($info['mpeg']['audio']['LAME']['short_version'])) {
                $info['audio']['encoder'] = rtrim($info['mpeg']['audio']['LAME']['short_version'], "\0");
            }
        }
        ...
        if (!empty($info['audio']['encoder'])) {
            $info['audio']['encoder'] = rtrim($info['audio']['encoder'], "\0 ");
        }
            ...
            switch ($ExplodedOptions[0]) {
                ...
                case '--r3mix':
                    ...
                    switch ($ExplodedOptions[1]) {
                        ...
                        case 'fast insane':
                        case 'r3mix':
                            static $ExpectedLowpass = array('insane|20500' => 20500, 'insane|20600' => 20600, 'medium|18000' => 18000, 'fast medium|18000' => 18000, 'extreme|19500' => 19500, 'extreme|19600' => 19600, 'fast extreme|19500' => 19500, 'fast extreme|19600' => 19600, 'standard|19000' => 19000, 'fast standard|19000' => 19000, 'r3mix|19500' => 19500, 'r3mix|19600' => 19600, 'r3mix|18000' => 18000);
                            ...
                            case '--alt-preset':
                                switch ($ExplodedOptions[1]) {
                                    ...
                                    case 'insane':
                                        ...
                                        break;
                                    default:
                                        static $ExpectedResampledRate = array('phon+/lw/mw-eu/sw|16000' => 16000, 'mw-us|24000' => 24000, 'mw-us|32000' => 32000, 'mw-us|16000' => 16000, 'phone|16000' => 16000, 'phone|11025' => 11025, 'radio|32000' => 32000, 'fm/radio|32000' => 32000, 'fm|32000' => 32000, 'voice|32000' => 32000);
    ...
    public function decodeMPEGaudioHeader($offset, &$info, $recursivesearch = true, $ScanAsCBR = false, $FastMPEGheaderScan = false)
    {
        ...
        if (substr($headerstring, 36, 4) == 'VBRI') {
            ...
            $SideInfoData = substr($headerstring, 6, $VBRidOffset - 4);
...
invalid Emphasis (' . $rawarray['emphasis'] . ')' : '';
    ...
    public static function XingVBRidOffset($version, $channelmode)
    {
        ...
        if (empty($XingVBRidOffsetCache)) {
            $XingVBRidOffsetCache = array('1' => array('mono' => 0x15, 'stereo' => 0x24, 'joint stereo' => 0x24, 'dual channel' => 0x24), '2' => array('mono' => 0xd, 'stereo' => 0x15, 'joint stereo' => 0x15, 'dual channel' => 0x15), '2.5' => array('mono' => 0x15, 'stereo' => 0x15, 'joint stereo' => 0x15, 'dual channel' => 0x15));
        }
