...
class DgEmailNotificationVersionQuery extends AbstractQuery
{
    ...
    public function _getMap()
    {
        ...
        return array_merge($parentMap, array('Id' => 'id', 'IdContent' => 'id_content', 'Title' => 'title', 'Pseudo' => 'pseudo', 'IdUser' => 'id_user', 'IdGroupe' => 'id_groupe', 'Langue' => 'langue', 'Type' => 'type', 'Subject' => 'subject', 'MessageTinymce' => 'message_tinymce', 'DateCreation' => 'date_creation'));
    }
}
